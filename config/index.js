export const config = {
  ...
  // 公众号APP_ID
  APP_ID: "wx87f8e4d1a8de2dc4",

  // 公众号APP_SECRET
  APP_SECRET: "a4fccd2eed2a8496f9a9a73123ed5832",
   ...
   */
  FESTIVALS: [
    {"type": "生日", "name": "老婆", "year": "2001", "date": "11-03"},
    {"type": "节日", "name": "在一起纪念日", "year": "2022", "date": "04-19"},
  ],
  ...
  SLOT_LIST: [
    // 这样配置的话，就会每次发送这句话
    {"keyword": "encourage_oneself", contents: "每一天......很想你......"},
    // 这样配置的话，就会每次随机选一句话发送
